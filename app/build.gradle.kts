...
// Function to get version name from gradle.properties
fun getVersionNameRelease(): String {
    val properties = Properties()
    properties.load(project.rootProject.file("gradle.properties").inputStream())
    return properties.getProperty("VERSION_NAME_RELEASE") ?: "1.0.0"
}
// Function to get version name from gradle.properties
fun getVersionNameDebug(): String {
    val properties = Properties()
    properties.load(project.rootProject.file("gradle.properties").inputStream())
    return properties.getProperty("VERSION_NAME_DEBUG") ?: "1.0.0"
}
android {
    ...
    defaultConfig {
         ...
         */
        buildConfigField ("String", "SECRET_KEY_2024", project.extra["SECRET_KEY_BAIS"].toString() )
